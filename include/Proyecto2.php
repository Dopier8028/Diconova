...
<body>
    ...
    <?php 
        ...
        <?php
        $projectTitle = "Hospital Civil Oriente, Tonalá,Jalisco";  
        ...
        <?php
        $galleryImages = [
            '../images/Proyectos/Sub proyectos/Hospital civil Oriente/img1.jpg',
            '../images/Proyectos/Sub proyectos/Hospital civil Oriente/img2.jpg',
            '../images/Proyectos/Sub proyectos/Hospital civil Oriente/img3.jpg'
        ];
        $projectTitle = "Hospital Civil Oriente, Tonalá,Jalisco";  
        include 'content.php';  
        ?>
