...
<body>
    ...
    <?php 
        ...
        <?php
        $projectTitle = "La Capilla de La Santa Cruz ubicada en el municipio de Jojutla Morelos"; 
        ...
        <?php
        $galleryImages = [
            '../images/Proyectos/Sub proyectos/Capilla/img1.png',
            '../images/Proyectos/Sub proyectos/Capilla/img2.png',
            '../images/Proyectos/Sub proyectos/Capilla/img3.png'
        ];
        $projectTitle = "La Capilla de La Santa Cruz ubicada en el municipio de Jojutla Morelos";  
        include 'content.php';  
        ?>
