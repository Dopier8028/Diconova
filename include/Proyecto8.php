...
<body>
    ...
    <?php 
        ...
        <?php
        $projectTitle = "Terminal Portugal Lazaro Cardenas";  
        ...
        <?php
        $galleryImages = [
        '../images/Proyectos/Sub proyectos/Terminal Portuugal Lazaro cardenas/img1.jpg',
        '../images/Proyectos/Sub proyectos/Terminal Portuugal Lazaro cardenas/img2.jpg',
        '../images/Proyectos/Sub proyectos/Terminal Portuugal Lazaro cardenas/img3.jpg',
        '../images/Proyectos/Sub proyectos/Terminal Portuugal Lazaro cardenas/img4.jpg'
        ];
        $projectTitle = "Terminal Portugal Lazaro Cardenas";  
        include 'content.php';  
        ?>
