...
$active_especialidades = ($current_page == 'Especialidades.html') ? 'active' : '';
        ...
        <?php
        $projectTitle = "Hospital Comunitario en Xichú, Guanajuato";  
        ...
        <?php
        $galleryImages = [
            '../images/Proyectos/Sub proyectos/Xichu/img1.jpg',
            '../images/Proyectos/Sub proyectos/Xichu/img2.jpg',
            '../images/Proyectos/Sub proyectos/Xichu/img3.gif'
        ];
        $projectTitle = "Hospital Comunitario en Xichú, Guanajuato";  
        include 'content.php';  
        ?>
