...
<body>
    ...
    <?php 
        ...
        <?php
        $projectTitle = "Plazas de Salud (PLASALUD) en Morelos, Guerrero y Ciudad de México";  
        ...
        <?php
        $galleryImages = [
            '../images/Proyectos/Sub proyectos/PLASALUD/img1.png',
            '../images/Proyectos/Sub proyectos/PLASALUD/img2.png',
            '../images/Proyectos/Sub proyectos/PLASALUD/img3.png',
            '../images/Proyectos/Sub proyectos/PLASALUD/img4.png'
        ];
        $projectTitle = "Plazas de Salud (PLASALUD) en Morelos, Guerrero y Ciudad de México";  
        include 'content.php';  
        ?>
